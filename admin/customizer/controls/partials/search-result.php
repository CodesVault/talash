...
function search_result($wp_customize) {
	...
	$wp_customize->add_setting( 'searchify_result_search_by_color', array(
		'default' 			=> '#9e9e9e',
	...
	$wp_customize->add_setting( 'searchify_result_title_color', array(
		'default' 			=> '#5e5e5e',
		'capability'    	=> 'edit_theme_options',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport' 		=> 'postMessage'
	...
	$wp_customize->add_setting( 'searchify_result_title_hover_color', array(
		'default' 			=> '#9e9e9e',
		'capability'    	=> 'edit_theme_options',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport' 		=> 'postMessage'
	...
	$wp_customize->add_setting( 'searchify_result_author_color', array(
		'default' 			=> '#9e9e9e',
		'capability'    	=> 'edit_theme_options',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport' 		=> 'postMessage'
	...
	$wp_customize->add_setting( 'searchify_result_cat_bg_color', array(
		'default' 			=> '#eeeeee',
		'capability'    	=> 'edit_theme_options',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport' 		=> 'postMessage'
	...
	$wp_customize->add_setting( 'searchify_result_cat_color', array(
		'default' 			=> '#9e9e9e',
		'capability'    	=> 'edit_theme_options',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport' 		=> 'postMessage'
